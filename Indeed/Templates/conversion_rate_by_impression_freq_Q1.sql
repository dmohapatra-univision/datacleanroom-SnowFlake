...
WITH vendor_test_data AS (
    SELECT 
        ...
        -- trunc'd to 1 hour
        ,try_to_timestamp(exposure_dtm_est) as  impression_timestamp
    ...
    FROM
        {{ app_data | sqlsafe }}.cleanroom.Indeed_2024_SMB_Job_Seeker_Exposure_vw --indeed_q1_brand_campaign_exposure
    WHERE
